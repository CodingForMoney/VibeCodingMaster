...
const requiredFiles = [
  ...
  "scripts/claude-plugins/vcm-lsp-bridge/.mcp.json",
  "scripts/claude-plugins/vcm-lsp-bridge/server.mjs",
  ...
  "dist/shared/types/code-intelligence.js",
