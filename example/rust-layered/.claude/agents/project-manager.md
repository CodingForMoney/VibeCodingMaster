...
- Debug flow: PM -> Architect Debug Mode -> Tester -> Architect docs sync when needed -> Final Acceptance.
- Docs-only flow: PM -> Architect -> Final Acceptance.
- Validation-only flow: PM -> Tester -> Final Acceptance.
